...
import { AnimatedSection, AnimatedImage, AnimatedStagger, StaggerItem } from "@/components/animations";
  ...
  return (
    <section id="hardware" className="bg-[#FAFAF8] border-t border-[#D1D5DB]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[780px]">
        ...
        <AnimatedImage className="relative bg-[#1A1917] min-h-[480px] lg:min-h-full overflow-hidden">
          <Image
        ...
        <div className="flex flex-col justify-center px-10 lg:px-20 py-24">
          ...
          {/* Catalog list */}
          <AnimatedStagger speed="fast" className="space-y-0">
            {categories.map((cat, i) => (
              <StaggerItem key={cat.title}>
                <div className="flex items-start gap-6 py-5 border-b border-[#D1D5DB] group cursor-default">
