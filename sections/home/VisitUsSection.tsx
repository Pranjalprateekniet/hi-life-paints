  ...
  return (
    <section id="visit-us" className="bg-[#FAFAF8] border-t border-[#D1D5DB]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5">
        ...
        <AnimatedImage className="relative lg:col-span-3 bg-[#F5F3EE] flex items-center justify-center p-8">
          <Image
        ...
        <div className="lg:col-span-2 flex flex-col justify-center px-10 lg:px-16 py-24 bg-[#FAFAF8]">
          ...
          {/* Details */}
          <AnimatedStagger className="space-y-6 mb-14">
            <StaggerItem>
      ...
      <AnimatedSection
        variant="fadeIn"
        className="border-t border-[#D1D5DB] bg-[#111111] px-6 lg:px-16 py-10"
      >
